...
# Load the tokenizer
with open(os.path.join(WORKING_DIR, 'tokenizer32k.pkl'), 'rb') as f:
    tokenizer = pickle.load(f)

# Load the trained model
model = load_model(os.path.join(WORKING_DIR, 'model32k.keras'))
...
#generate_caption("C:/Users/bossu/OneDrive/Desktop/instabot/ImageCaptionGenerator/New folder/images.jpg")
